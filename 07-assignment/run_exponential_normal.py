...
if __name__ == '__main__':
    ...
    model_directory = Path('07-assignment/normal_exponential_model/')

    model = load_stan_model(model_directory / 'normal_exponential_model.stan')

    fit, fit_summary, fit_model = fit_stan_model(model, data, iter=10000, warmup=5000)
